...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title: "Poonoo!!!❤️, You’ve stolen my heart completely!!! 🥰💖 But itni pyaari ladki aur itni jaldi haan? Thoda aur nakhre karke Ashu ko tarpaao na! 🥰✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
        ...
        {yesPressed && noCount > 3 ? (
          <>
            <img
              ...
              alt="Yes Response"
            />
            <div className="text-4xl md:text-6xl font-bold my-2" style={{ fontFamily: "Charm, serif", fontWeight: "700", fontStyle: "normal" }}>I Love You Poonoo !!!</div>
            <div className="text-4xl md:text-4xl font-bold my-1" style={{ fontFamily: "Beau Rivage, serif", fontWeight: "500", fontStyle: "normal" }}> You’re the love of Ashu's life. </div>
            <WordMareque />
          </>
        ) : (
          <>
            ...
            <h1 className="text-4xl md:text-6xl my-4 text-center">
              Poonoo, will you be my Valentine?
            </h1>
